...
1. T1_1mm.nii:    3D T1-weighted scan (voxel size: 1.0mm x 1.0mm x 1.0mm)
2. T1.nii:        3D T1-weighted scan registered to the T2 FLAIR (voxel size: 0.958mm x 0.958mm x 3.0mm)
3. T1_IR.nii:     Multi-slice T1-weighted inversion recovery scan registered to the T2 FLAIR (voxel size: 0.958mm x 0.958mm x 3.0mm)
4. T2_FLAIR.nii:  Multi-slice FLAIR scan (voxel size: 0.958mm x 0.958mm x 3.0mm)
